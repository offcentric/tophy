...
ul#nav li a:hover{color:#9F6024;}
...
ul.subnav li.subitem_on{
	background-color:#9F6024 ! important;
	font-weight:bold;
}

ul.subnav li:hover a:hover{background-color:#666 ! important;}
ul.subnav li.subitem_on:hover{ background-color:#9F6024 ! important; }
