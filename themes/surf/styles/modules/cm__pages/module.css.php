...
div.contact form input.text{height:18px; padding:2px 2px 0 2px; line-height:18px;}
...
div.contact form input.submit{color:#0075b2; display:block; float:none; margin-left:180px; margin-right:0px; height:30px; width:80px;}
...
div.content h1{display:block;font-size:1.6em;margin:0 0 10px 0;background-color:none;border-bottom:1px solid #0075b2;text-align:left;}
div.content h2{margin:20px 0 10px 0;padding:3px 0;font-size:1.3em;border-bottom:1px solid #550088;border-bottom:1px solid #0075b2;}
...
/* FORM PAGES */
div.errordiv{ padding-top:0 ! important; display:block-inline; width:300px; margin:0 auto 5px auto; text-align:center;}
.errordiv div, p.error{font-weight:bold; padding:0 10px; line-height:22px; color:#ff0000; font-size:0.9em;}
p.smallerror, .smallerror div{font-size:0.8em; line-height:14px; color:#ff0000; width:255px ! important;}
span.smallerror{left:0px; line-height:14px; color:#ff0000; font-size:0.9em; display:block;}