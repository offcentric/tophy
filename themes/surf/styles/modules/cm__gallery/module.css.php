...
body.display_thumbnails div.pagecontainer div.bookpage div.item{
	position: relative;
	display:inline-block;
	margin: 10px;
}
...
body.display_thumbnails div.exif_info_column{float:left;background-color:#444;height:15px;margin:2px 0;width:100%;white-space:nowrap;overflow:hidden;color: #eeeeee;}
