...
if(isset($_SESSION['cm__gallery']['menu']) && $_SESSION['cm__gallery']['menu']['dropdown'] == "true") $menu_html .= " dropdown";
$menu_html .= "\">";
$x = 0;

if(isset($_SESSION['cm__gallery']['menu']) && isset($_SESSION['cm__gallery']['menu']['items'])){
